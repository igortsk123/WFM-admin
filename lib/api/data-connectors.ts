...
const MOCK_DATA_CONNECTORS: DataConnector[] = [
  {
    id: "dc-001",
    type: "PLANNER",
    name: "LAMA — Томск (центральный)",
    status: "ACTIVE",
    config: { host: "wfm-smart.lama70.ru", port: 443, timeout_sec: 30 },
    stats: {
      records_per_day: 47,
    ...
    scope: { store_ids: [200, 201, 202, 203, 204, 205] },
  },
  {
    id: "dc-002",
    type: "POS",
    name: "POS LAMA — кассы",
    status: "ACTIVE",
    config: { provider: "DATECS", api_url: "https://pos.lama70.ru/api" },
    stats: {
    ...
    organization_id: "org-lama",
    scope: { store_ids: [200, 201, 202] },
  },
  {
    id: "dc-003",
    type: "INVENTORY",
    name: "WMS остатки — LAMA",
    status: "DEGRADED",
    config: { api_url: "https://wms.lama70.ru/api/v2", update_interval_min: 240 },
    stats: {
  ...
  },
  {
    id: "dc-005",
    type: "PLANNER",
    name: "ТехПродЗдрав — учётная система цеха",
    status: "ACTIVE",
    config: { host: "erp.tehprodzdrav.local", port: 443 },
    stats: {
      records_per_day: 23,
  ...
  },
  {
    ...
    name: "Telegram-канал распродаж Левас",
    status: "ACTIVE",
    config: { bot_token_masked: "***masked***", channel_id: "@levas_sales" },
    stats: {
      records_per_day: 2,
  ...
  },
  {
    id: "dc-007",
    type: "SUPPLY",
    name: "Поставки — EDI поставщики LAMA",
    status: "DISCONNECTED",
    config: { edi_format: "EANCOM", provider: "EDI-Гейт" },
    organization_id: "org-lama",
  },
];
