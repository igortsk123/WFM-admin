...
export const MOCK_GOALS: Goal[] = [
  {
    ...
    title_en: "Reduce dairy OOS by 15% in a week",
    description: "Активная цель: снизить Out-of-Stock в категории «Молочка» по сети с текущих 6.2% до 5.3% (−15%) за 7 дней.",
    description_en: "Active goal: reduce Out-of-Stock in the Dairy category network-wide from 6.2% down to 5.3% (−15%) in 7 days.",
    starting_value: 6.2,
    target_value: 5.3,
    target_unit: "%",
    current_value: 5.9,
    ...
    money_impact: {
      ...
      rationale_short_en: "−15% dairy OOS ≈ +450,000 ₽/week network-wide",
      rationale_breakdown: [
      ...
      rationale_breakdown_en: [
        "Dairy category: ~30% of store revenue (≈ 3M ₽/week on average)",
        "−1 pp OOS yields +3–5% category sales (historical POS analysis)",
        "Network effect: 132 stores × ~5% × attribution coefficient 0.7",
        "Total: ≈ 450,000 ₽ additional weekly revenue at the 5.3% target",
      ],
    },
  },
  {
    ...
    title_en: "Bring bakery write-offs down to target",
    description: "Списания хлебобулочных изделий по сети 3.8% при норме 2.5%. Цель — снизить до 2.5% за 14 дней.",
    description_en: "Bakery write-offs are at 3.8% network-wide vs the 2.5% target. Goal: bring it down to 2.5% within 14 days.",
    starting_value: 3.8,
    target_value: 2.5,
    target_unit: "%",
    current_value: 3.8,
    ...
    money_impact: {
      ...
      rationale_short_en: "−1.3 pp write-offs ≈ −280,000 ₽/week saved",
      rationale_breakdown: [
      ...
      rationale_breakdown_en: [
        "Current network-wide write-offs in this category: ~820,000 ₽/week",
        "Reducing 3.8% → 2.5% (target) = −34% of current write-offs",
        "132 stores × average saving 2,100 ₽/store/week",
        "Coefficient source: historical write-off analysis after FIFO control rollout",
      ],
    },
  },
  {
    ...
    title_en: "Improve promo merchandising quality at G-1 Kotovskogo",
    description: "Проверки показали 42% несоответствий с промо-стандартом. Целевой уровень — 15% и ниже к концу мая.",
    description_en: "Audits show 42% deviations from the promo standard. Target: 15% or lower by end of May.",
    starting_value: 42,
    target_value: 15,
    target_unit: "%",
    current_value: 42,
    ...
    money_impact: {
      ...
      rationale_short_en: "On-standard promo at this store ≈ +95,000 ₽/month conversion",
      rationale_breakdown: [
      ...
      rationale_breakdown_en: [
        "Promo zones generate ~15% of monthly store revenue (~1.2M ₽)",
        "−27 pp deviations = +8% promo conversion (from A/B data)",
        "1.2M × 8% × attribution coefficient 1.0 ≈ 95,000 ₽/month",
        "Source: post-promo lift analysis on comparable store formats",
      ],
    },
  },
  {
    ...
    title_en: "Zero price tag mismatches in the alcohol section",
    description: "По итогам апрельской проверки — 7 ценников не совпали с ценой на кассе. Цель: 0 расхождений.",
    description_en: "April audit found 7 price tags mismatching POS prices. Goal: zero mismatches.",
    starting_value: 7,
    target_value: 0,
    target_unit: "шт.",
    current_value: 7,
    ...
    money_impact: {
      ...
      rationale_short_en: "Zero POS complaints ≈ −38,000 ₽/month in compensations",
      rationale_breakdown: [
      ...
      rationale_breakdown_en: [
        "Average compensation per price mismatch complaint: ~5,400 ₽ (refund + voucher)",
        "April: 7 mismatches; historical baseline 6–8 complaints/month",
        "Zero mismatches goal = ~38,000 ₽/month direct savings",
        "Reputational impact and loyal-customer churn-rate not accounted for",
      ],
    },
  },
  {
    ...
    title_en: "Raise task completion at SPAR Novosibirsk to 88%",
    description: "Апрельский показатель SPAR-NSK-001 — 82.6%. Цель: достичь 88% к концу мая за счёт нормализации выполнения задач.",
    description_en: "SPAR-NSK-001 completion in April: 82.6%. Goal: reach 88% by end of May through normalised task execution.",
    starting_value: 82.6,
    target_value: 88,
    target_unit: "%",
    current_value: 82.6,
    ...
    money_impact: {
      ...
      rationale_short_en: "+5.4 pp task completion ≈ +64,000 ₽/month payroll efficiency",
      rationale_breakdown: [
      ...
      rationale_breakdown_en: [
        "+5.4 pp = ~32 person-hours of bonus time saved per month",
        "Average task rate: ~300 ₽/hour",
        "32h × 300 ₽ + reduced shift-tail payroll overrun ≈ 64,000 ₽/month",
        "Indirect effect: 12% drop in OOS incidents (correlated KPI)",
      ],
    },
  },
  {
    ...
    title_en: "Reduce OOS in frozen products",
    description: "Завершённая цель: OOS по заморозке снизился с 8.1% до 4.7%. Целевой уровень — 5%.",
    description_en: "Completed goal: frozen-products OOS dropped from 8.1% to 4.7%. Target was 5%.",
    starting_value: 8.1,
    target_value: 5.0,
    target_unit: "%",
    current_value: 4.7,
    ...
    money_impact: {
      ...
      rationale_short_en: "−3.4 pp frozen OOS ≈ +1.7M ₽/month revenue",
      rationale_breakdown: [
      ...
      rationale_breakdown_en: [
        "Frozen products: ~12% of monthly revenue (≈ 14M ₽ network-wide)",
        "−3.4 pp OOS × 3.5% lift per pp ≈ +12% category sales",
        "14M × 12% ≈ 1.7M ₽/month",
        "Goal closed with overshoot (4.7% < 5.0%) — actual impact exceeded forecast",
      ],
    },
  },
];
