...
export const MOCK_GOALS: Goal[] = [
  {
    ...
    description:
      "AI заметил по чекам последних 30 дней провалы продаж в ходовых товарах. По сети сейчас 6.0% пустых полок в ходовом ассортименте — цель 5.0% за 8 недель. Это вернёт около 810 000 ₽ выручки в неделю.",
    description_en:
      "AI saw POS gaps in fast-moving SKUs over the last 30 days. Network-wide empty-shelf rate 6.0% in fast-movers — goal 5.0% in 8 weeks. Brings back ~810,000 ₽/week.",
    starting_value: 6.0,
    target_value: 5.0,
    target_unit: "%",
    current_value: 5.9,
    ...
    ai_evidence: [
      ...
      },
      {
        source: "erp-stock",
        summary:
          "Учётная система показывает остаток 0 в 5 из 7 магазинов; в остальных >40, но полка пустая — задача на подсобку",
        summary_en:
          "ERP shows 0 stock in 5 of 7 stores; the other 2 have >40 but the shelf is empty — back-room task",
        observed_from: "2026-04-28T11:00:00+07:00",
    ...
    money_impact: {
      ...
      period: "week",
      impact_type: "money",
      rationale_short: "Меньше пустых полок в ходовых ≈ +810 000 ₽/нед",
      rationale_short_en: "Fewer empty fast-mover shelves ≈ +810,000 ₽/week",
      rationale_breakdown: [
        "Сетевая выручка 25 млрд ₽/год → 480,8 млн ₽/нед",
        "Берём 35% выручки — ходовые товары (600 SKU)",
      ...
      rationale_breakdown_en: [
        ...
        "35% of revenue is fast-movers (600 SKUs)",
  ...
  },
  {
    ...
    description:
      "AI каждый день после 14:00 сверяет остатки учётной системы с продажами по чекам — находит товары где остаток есть, но за день ноль продаж при норме ≥3 шт/день. Сегодня 14 таких — нужно проверить (на полке / в подсобке / списан / не нашли) до конца смены. Ожидаемый эффект — около 280 000 ₽ в неделю.",
    description_en:
      "Each day after 14:00 AI reconciles ERP stock with POS sales — finds SKUs with stock but zero sales today against ≥3/day baseline. 14 today — locate-and-report (shelf / back-room / written-off / not found) before close. Expected effect ≈ 280,000 ₽/week.",
    starting_value: 14,
    target_value: 0,
    target_unit: "шт.",
    current_value: 14,
    ...
    ai_signal_source: "mixed",
    ai_detection_method:
      "Каждый день после 14:00 AI сверяет остатки учётной системы с продажами по чекам — товары с остатком ≥1, продажами 0 за день и нормой ≥3 шт/день за последние 14 дней попадают в список «подозрительных». На каждый создаётся подзадача: «найти и отчитаться (на полке / в подсобке / списан / не нашли)».",
    ai_detection_method_en:
    ...
    ai_evidence: [
      {
        source: "mixed",
        summary:
          "14 товаров с остатком ≥1 шт и 0 продаж за сегодня (среднесуточная норма 3-12 шт/день за 14 дней)",
        summary_en:
  ...
  },
  {
    ...
    description:
      "AI заметил по остаткам и приёмкам, что свежие категории (хлеб, молочка, готовая еда, овощи-фрукты) залёживаются дольше нормы. Списания сейчас 2,2% от продаж этих категорий — цель 1,8% за 12 недель. Ожидаемая экономия — около 350 000 ₽ в неделю.",
    description_en:
      "AI saw on stock + receipts that fresh categories (bakery, dairy, ready-to-eat, produce) sit on shelves past target. Write-offs at 2.2% of fresh sales — goal 1.8% over 12 weeks. Expected savings ≈ 350,000 ₽/week.",
    starting_value: 2.2,
    target_value: 1.8,
    target_unit: "%",
    current_value: 2.2,
    ...
    ai_evidence: [
      ...
      },
      {
        source: "pos-cheque",
        summary:
          "Продажи свежего хлеба после 19:00 падают на 60% — подсобка не успевает вынести в зал",
        summary_en:
          "Fresh bakery sales drop 60% after 19:00 — back-room can't keep up",
        observed_from: "2026-04-15",
        observed_to: "2026-04-29",
  ...
  },
  {
    ...
    description:
      "AI заметил по продажам и поставкам, что после акций остаётся слишком много товара (D+7 непроданные остатки — 16% от поставленного, цель 12%). По сети 132 магазина, эффект — около 2,00 млн ₽ в месяц спасённой выручки на промо.",
    description_en:
      "AI saw too much stock left over after promos (D+7 residual 16% of receipts, goal 12%). Across 132 stores, the effect is ≈ 2.00M ₽/month preserved.",
    starting_value: 16,
    target_value: 12,
    target_unit: "%",
    current_value: 16,
    ...
    ai_evidence: [
      {
        source: "pos-cheque",
        summary:
          "Кампания «Майские хиты» (28 апр — 5 мая): по 18 товарам в 30 магазинах непроданные остатки на D+7 — 21% против цели 12%",
        summary_en:
          "‘May Hits’ campaign (Apr 28 – May 5): 18 SKUs across 30 stores show D+7 residual 21% vs 12% target",
        observed_from: "2026-04-28",
        observed_to: "2026-05-05",
        scope_hint: "18 акционных товаров / 30 магазинов",
        scope_hint_en: "18 promo SKUs / 30 stores",
      },
      {
        source: "erp-stock",
        summary:
          "Распределение по магазинам неравномерное: в 6 хайперах остатки >35%, в 12 магазинах меньшего формата — пустые полки",
        summary_en:
          "Allocation skewed: 6 hyperstores hold >35% residual, 12 smaller stores stocked out mid-campaign",
        observed_from: "2026-04-28",
        observed_to: "2026-05-05",
        scope_hint: "Промо-зона / 18 магазинов с дисбалансом",
        scope_hint_en: "Promo zone / 18 stores with imbalance",
      },
    ],
    money_impact: {
      amount: 2_000_000,
  ...
  {
    id: "goal-slowmoving-1",
    category: "WRITE_OFFS",
    title: "Залежавшийся товар",
    title_en: "Slow-moving stock",
    description:
      "AI каждую неделю смотрит остатки которые лежат больше 45 дней без сезонной причины. Сейчас у сети залежавшегося товара на 42 млн ₽; цель — сократить до 30 млн ₽, высвободив 12 млн ₽ оборотных средств. Постоянная экономия — около 110 000 ₽ в неделю + единоразовое высвобождение 12 млн ₽.",
    description_en:
      "Each week AI scans stock sitting over 45 days with no seasonal reason. Network slow-moving pool is 42M ₽; goal — cut to 30M ₽ and release 12M ₽ of working capital. Recurring savings ≈ 110,000 ₽/week + 12M ₽ one-off.",
    starting_value: 42,
    target_value: 30,
    target_unit: "млн ₽",
    current_value: 42,
    ...
    ai_evidence: [
      {
        source: "erp-stock",
        summary:
          "У сети 412 товаров с запасом более 45 дней без сезонной причины — заморожено около 42 млн ₽",
        summary_en:
          "Network has 412 SKUs with >45-day cover and no seasonal reason — about 42M ₽ frozen",
        observed_from: "2026-04-26",
        observed_to: "2026-05-10",
        scope_hint: "412 товаров / непродовольственные, бакалея, бытовая химия",
        scope_hint_en: "412 SKUs / non-food, groceries, household chemicals",
      },
    ],
    money_impact: {
      amount: 110_000,
  ...
  {
    id: "goal-promo-2-execution",
    category: "PROMO_QUALITY",
    title: "Промо-выкладка по стандарту",
    title_en: "Promo display by the standard",
    description:
      "AI выявил по фото от Ивановой М.А. (5 мая, 09:15, торцевая полка Г-1) и сравнению с похожими магазинами по чекам, что промо-выкладка отклоняется от стандарта на 42%. Цель — 15% к концу мая.",
    description_en:
      "AI detected via photo from M.A. Ivanova (May 5, 09:15, end-cap G-1) and POS comparison with similar stores: promo deviates 42% from standard. Goal: 15% by end of May.",
    starting_value: 42,
    target_value: 15,
    target_unit: "%",
    current_value: 42,
    ...
    ai_signal_source: "mixed",
    ai_detection_method:
      "AI комбинирует две метрики: (1) распознавание фото торцевой полки от сотрудника против эталонной схемы выкладки; (2) сравнение продаж акционных товаров магазина с похожими магазинами по чекам. Совпадение детекции >0,7 = проблема подтверждена.",
    ai_detection_method_en:
      "AI combines two signals: (1) CV-recognised end-cap photo vs reference planogram; (2) POS comparison of promo-SKU sales vs comparable stores. Detection match > 0.7 = problem confirmed.",
    ai_evidence: [
      {
        source: "photo-bonus",
        summary:
          "Иванова М.А. сняла фото торцевой полки в 09:15 — распознавание нашло 8 из 14 товаров не на местах",
        summary_en:
          "M.A. Ivanova snapped end-cap photo at 09:15 — CV found 8 of 14 SKUs misplaced",
        observed_from: "2026-05-05T09:15:00+07:00",
        scope_hint: "Торцевая полка зоны G-1 / промо-выкладка май",
      ...
      },
      {
        source: "pos-cheque",
        summary:
          "Продажи 8 акционных товаров в Г-1 на 27 п.п. ниже похожих магазинов того же формата",
        summary_en:
          "Sales of 8 promo SKUs in G-1 are 27pp below comparable same-format stores",
        observed_from: "2026-04-29",
        observed_to: "2026-05-05",
        scope_hint: "8 акционных товаров / Г-1 Котовского / торцевая полка",
    ...
    money_impact: {
      ...
      rationale_breakdown: [
        ...
        "27 п.п. × 0,7% × 2,7 млн × 65% вклад магазина ≈ 260 000 ₽/мес",
        "Сейчас в Г-1 Котовского 58% соблюдения, у лидеров — 91% (Nielsen 2024)",
      ],
      rationale_breakdown_en: [
