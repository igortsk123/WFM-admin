...
export const MOCK_ASSIGNMENTS: Assignment[] = [
  ...
  { id: 10, user_id: 10, position_id: 7, position_name: "Директор магазина", store_id: 200, store_name: "Г-1 Котовского 19/3 (ГМ)", rank: { id: 1, code: "RANK-1", name: "Стандарт" }, active: true },
  ...
  // SUPERVISOR Тарасова
  { id: 12, user_id: 12, position_id: 8, position_name: "Супервайзер", store_id: 200, store_name: "Г-1 Котовского 19/3 (ГМ)", rank: { id: 1, code: "RANK-1", name: "Стандарт" }, active: true },
  // HR_MANAGER Морозова
  ...
  { id: 23, user_id: 23, position_id: 4, position_name: "Продавец-консультант", store_id: 200, store_name: "Г-1 Котовского 19/3 (ГМ)", rank: { id: 1, code: "RANK-1", name: "Стандарт" }, active: true },
  { id: 24, user_id: 24, position_id: 5, position_name: "Кладовщик", store_id: 200, store_name: "Г-1 Котовского 19/3 (ГМ)", rank: { id: 1, code: "RANK-1", name: "Стандарт" }, active: true },
  { id: 25, user_id: 25, position_id: 2, position_name: "Кассир", store_id: 270, store_name: "С-6 Мичурина 37 (П)", rank: { id: 1, code: "RANK-1", name: "Стандарт" }, active: true },
  { id: 26, user_id: 26, position_id: 6, position_name: "Мерчендайзер", store_id: 270, store_name: "С-6 Мичурина 37 (П)", rank: { id: 1, code: "RANK-1", name: "Стандарт" }, active: true },
  ...
  // ── Extras (id 35-104) ───────────────────────────────────────
  { id: 35, user_id: 35, position_id: 2, position_name: "Кассир", store_id: 270, store_name: "С-6 Мичурина 37 (П)", rank: { id: 1, code: "RANK-1", name: "Стандарт" }, active: true },
  ...
  { id: 39, user_id: 39, position_id: 6, position_name: "Мерчендайзер", store_id: 200, store_name: "Г-1 Котовского 19/3 (ГМ)", rank: { id: 1, code: "RANK-1", name: "Стандарт" }, active: true },
  ...
  { id: 43, user_id: 43, position_id: 6, position_name: "Мерчендайзер", store_id: 200, store_name: "Г-1 Котовского 19/3 (ГМ)", rank: { id: 1, code: "RANK-1", name: "Стандарт" }, active: true },
  ...
  { id: 52, user_id: 52, position_id: 1, position_name: "Универсал", store_id: 270, store_name: "С-6 Мичурина 37 (П)", rank: { id: 1, code: "RANK-1", name: "Стандарт" }, active: true },
  ...
  { id: 54, user_id: 54, position_id: 4, position_name: "Продавец-консультант", store_id: 270, store_name: "С-6 Мичурина 37 (П)", rank: { id: 1, code: "RANK-1", name: "Стандарт" }, active: true },
  ...
  { id: 62, user_id: 62, position_id: 4, position_name: "Продавец-консультант", store_id: 200, store_name: "Г-1 Котовского 19/3 (ГМ)", rank: { id: 1, code: "RANK-1", name: "Стандарт" }, active: true },
  ...
  { id: 64, user_id: 64, position_id: 3, position_name: "Старший кассир", store_id: 270, store_name: "С-6 Мичурина 37 (П)", rank: { id: 1, code: "RANK-1", name: "Стандарт" }, active: true },
  ...
  { id: 66, user_id: 66, position_id: 3, position_name: "Старший кассир", store_id: 200, store_name: "Г-1 Котовского 19/3 (ГМ)", rank: { id: 1, code: "RANK-1", name: "Стандарт" }, active: true },
  { id: 67, user_id: 67, position_id: 1, position_name: "Универсал", store_id: 200, store_name: "Г-1 Котовского 19/3 (ГМ)", rank: { id: 1, code: "RANK-1", name: "Стандарт" }, active: true },
  ...
  { id: 72, user_id: 72, position_id: 2, position_name: "Кассир", store_id: 200, store_name: "Г-1 Котовского 19/3 (ГМ)", rank: { id: 1, code: "RANK-1", name: "Стандарт" }, active: true },
