...
export const REAL_LAMA_REVIEW_TASKS: Task[] = [
  { id: "task-lama-review-487094", external_id: 487094, title: "Переоценка", description: "Переоценка", type: "PLANNED", kind: "SINGLE", source: "PLANNED", store_id: 225, store_name: "У-19 Сибирская 104а", zone_id: 112, zone_name: "Без зоны", work_type_id: 5, work_type_name: "Переоценка", priority: 1, editable_by_store: false, creator_id: 1, creator_name: "Директор магазина", assignee_id: 433, assignee_name: "Никифорова Наталья Владимировна", assigned_to_permission: null, state: "COMPLETED", review_state: "ACCEPTED", acceptance_policy: "MANUAL", requires_photo: false, archived: false, planned_minutes: 10, time_start: "06:00:00", time_end: "06:10:00", shift_id: 5812972, created_at: "2026-07-13T06:00:00+07:00", updated_at: "2026-07-13T06:10:00+07:00" },
];

export const REVIEW_TASKS_BUILT_AT = "2026-07-13T00:02:35Z";
export const REVIEW_TASKS_SOURCE_DATE = "2026-07-13";
