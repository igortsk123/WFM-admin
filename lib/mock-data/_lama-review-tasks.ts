...
export const REAL_LAMA_REVIEW_TASKS: Task[] = [
  { id: "task-lama-review-602858", external_id: 602858, title: "Переоценка", description: "Переоценка", type: "PLANNED", kind: "SINGLE", source: "PLANNED", store_id: 211, store_name: "У-03 Фрунзе 120 (ИР)", zone_id: 112, zone_name: "Без зоны", work_type_id: 5, work_type_name: "Переоценка", priority: 1, editable_by_store: false, creator_id: 1, creator_name: "Директор магазина", assignee_id: 437, assignee_name: "Райхе Наталья Анатольевна", assigned_to_permission: null, state: "COMPLETED", review_state: "ON_REVIEW", acceptance_policy: "MANUAL", requires_photo: false, archived: false, planned_minutes: 15, time_start: "07:00:00", time_end: "07:15:00", shift_id: 5863095, created_at: "2026-08-24T07:00:00+07:00", updated_at: "2026-08-24T07:15:00+07:00" },
];

export const REVIEW_TASKS_BUILT_AT = "2026-08-24T00:01:07Z";
export const REVIEW_TASKS_SOURCE_DATE = "2026-08-24";
