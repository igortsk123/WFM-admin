...
- `GET /operations?work_type_id=X&zone_id=Y` — список операций для пары (тип работы, зона). Возвращает ACCEPTED + PENDING, исключает REJECTED.
...
- `backend/svc_tasks/alembic/versions/022-024_*.py` — миграции
