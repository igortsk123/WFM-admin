"""Remove user_roles and worker_permissions tables (moved to svc_users)
...
def upgrade() -> None:
    """Удаление таблиц user_roles и worker_permissions (перенесены в svc_users)"""
...
def downgrade() -> None:
    """Восстановление таблиц user_roles и worker_permissions"""
